...
const layersConfig = [
  ...
  // C (sistemas cacaoteros) y D (otros usos productivos y antrópicos).
  {
    ...
    label: "Cobertura y uso del suelo (año 2015)",
  ...
  // sobre el mapa.
  {
    ...
    label: "Mapa oficial cobertura 2015 (imagen)",
    type: "image_overlay",
    ...
    fitOnEnable: true,
    legendItems: [{ fill: "#FFFFFF", border: "#6B7280", label: "Mapa oficial cobertura 2015 (imagen)" }],
  },
];
