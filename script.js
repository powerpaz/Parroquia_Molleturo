...
const COBERTURA_CACAO_STYLE = {
  "Cultivos de exclusivos de cacao": { fill: "#A57159", border: "#7A4F3D" },
  "Cultivos mixtos de cacao": { fill: "#F0BB5B", border: "#C28F2E" },
  "Cacao con teca y cultivos mixtos": { fill: "#A48A57", border: "#3DBFA0" },
  _default: { fill: "#A48A57", border: "#6B7280" },
};
...
const layersConfig = [
  ...
  // una librería adicional).
  {
    ...
    onEachFeature: (f, l) => {
      const p = f.properties || {};
      l.bindPopup(`
        <b>Área protegida:</b> ${p.Nombre ?? "s/i"}<br>
  ...
  // "Comunidades / Puntos de estudio" (verde) ni "Poblados (referencia)"
  // (negro, del catálogo de transición).
  {
    id: "PobladosIGM250",
